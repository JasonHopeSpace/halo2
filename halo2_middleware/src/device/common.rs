// use crate::plonk::evaluation::{Calculation, CalculationInfo, ValueSource};
use libc::c_void;
...
/// MSM param unit as multiple circuits require multiple params.
#[derive(Clone, Debug)]
pub struct MSMParamUnitNew {
    ///
    pub is_cached_bases: bool,
    ///
    pub is_cached_scalars: bool,
    ///
    pub bases_id: usize,
    ///
    pub scalars_id: usize,
    ///
    pub gm: PandaGpuManager,
}
